 ...
 * @author nopal
 */
public class reg_kategori extends javax.swing.JFrame {
private Connection conn = new koneksi().connect();
    ...
    public void getDataid(String id){
        ...
        jLabel16.setText("          Ubah Data kategori");        
        txt_kode.setText(home.id_kategori);
        String a = txt_kode.getText();
        txt_kode.setEnabled(false);
        try{
            String sql="select * from kategori where kode='"+a+"'";
            ...
            JOptionPane.showMessageDialog(null,"data kategori gagal dipanggil : "+ e);
            }
    }
    ...
    private void initComponents() {
        ...
        jLabel16.setText("                  Tambah Data Kategori");
        ...
        jLabel12.setText("       Nama Kategori Barang");
    ...
    private void b_simpanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_b_simpanMouseClicked
        ...
        try{
            ...
            stat.executeUpdate();
            JOptionPane.showMessageDialog(null,"Data Kategori Barang Berhasil Disimpan");
            kosong();
            txt_nama.requestFocus();
        }
        catch (SQLException e){
            JOptionPane.showMessageDialog(null,"Data Kategori Gagal Disimpan : "+ e);
        }
    ...
    private void b_editMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_b_editMouseClicked
        ...
        try{
            String sql="update kategori set nama=?,keterangan=? where kode='"+b+"'";
            PreparedStatement stat=conn.prepareStatement(sql); 
