 ...
 * @author nopal
 */
public class reg_company extends javax.swing.JFrame {
private Connection conn = new koneksi().connect();
public home dataa=null;
    ...
    public void getDataid(String id){
        ...
        jLabel16.setText("                  Ubah Data Perusahaan");
        pp.dataa=this;
        txt_kode.setText(id);
        String a = txt_kode.getText();
        txt_kode.setEnabled(false);
        try{
            String sql="select * from perusahaan where kode='"+a+"'";
            ...
            JOptionPane.showMessageDialog(null,"data perusahaan gagal dipanggil : "+ e);
            }
    }
    ...
    private void initComponents() {
        ...
        jLabel16.setText("             Tambah Data Perusahaan");
    ...
    private void b_editMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_b_editMouseClicked
        ...
        try{
            String sql="update perusahaan set nama=?,alamat=?,keterangan=? where kode='"+b+"'";
            PreparedStatement stat=conn.prepareStatement(sql); 
    ...
    private void jPanel15MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel15MouseClicked
        ...
        if (ok==0){
            String sql="delete from perusahaan where kode='"+txt_kode.getText()+"'";
            try{
                PreparedStatement stat = conn.prepareStatement(sql);
                stat.executeUpdate();
