 ...
 * @author nopal
 */ 
public class reg_brands extends javax.swing.JFrame {
...
//public home datab=null;
    ...
    public void getDataid(String id){
        ...
        jLabel16.setText("               Ubah Data Merk");        
        txt_kode.setText(home.id_brands);
        String a = txt_kode.getText();
        txt_kode.setEnabled(false);
        try{            
            String sql="SELECT merk.kode, merk.nama,merk.kode_kategori, kategori.nama, merk.keterangan "
                    + "FROM merk inner join kategori on merk.kode_kategori=kategori.kode "
                    + "where merk.kode='"+a+"'";
            Statement st = conn.createStatement(); ResultSet rs = st.executeQuery(sql);             
            while (rs.next()){
             txt_kode.setText(rs.getString("merk.kode"));
             txt_nama.setText(rs.getString("merk.nama"));
             cb_kategori.setSelectedItem(rs.getString("kategori.nama"));
             txt_keterangan.setText(rs.getString("merk.keterangan"));
             }
        }
    ...
    private void initComponents() {
        ...
        jLabel16.setText("            Tambah Data Brands/Merk");
        ...
        jLabel13.setText("       Kategori Brand");
    ...
    private void b_simpanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_b_simpanMouseClicked
        ...
        try{            
            ...
            stat.executeUpdate();
            JOptionPane.showMessageDialog(null,"Data Brands/Merk Berhasil Disimpan");
            kosong();
            txt_nama.requestFocus();
        }
        catch (SQLException e){
    ...
    private void b_editMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_b_editMouseClicked
        ...
        String asql="select kode from kategori where nama='"+cb_kategori.getSelectedItem().toString()+"'";  
        String sql="update merk set nama=?,kode_kategori=?,keterangan=? where kode='"+b+"'";        
        try{
            String a="";
            Statement st = conn.createStatement(); ResultSet rs = st.executeQuery(asql); 
            while (rs.next()){a=rs.getString("kode");}
